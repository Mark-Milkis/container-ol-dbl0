...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ol-dbl0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ol-dbl0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Mark-Milkis/container-ol-dbl0.git
cd container-ol-dbl0
```
...
```
docker attach container-ol-dbl0
```
